...
namespace Firma.Intranet.Controllers
{
    public class StronaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,LinkTytul,TytulStrone,Tresc,Pozycja")] Strona strona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,LinkTytul,TytulStrone,Tresc,Pozycja")] Strona strona)
        {
