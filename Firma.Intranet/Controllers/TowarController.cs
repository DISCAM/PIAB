...
namespace Firma.Intranet.Controllers
{
    public class TowarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTowaru,IdRodzaju,Kod,Nazwa,Cena,Opis,FotoUrl")] Towar towar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTowaru,IdRodzaju,Kod,Nazwa,Cena,Opis,FotoUrl")] Towar towar)
        {
